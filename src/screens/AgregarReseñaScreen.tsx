...
const AgregarReseñaScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      // Supongamos que el correo electrónico de la óptica está en el producto
      const opticaEmail = producto.opticaEmail;
      ...
      const newReview = {
        ...
        opticaEmail,  // Agregar el correo electrónico de la óptica
